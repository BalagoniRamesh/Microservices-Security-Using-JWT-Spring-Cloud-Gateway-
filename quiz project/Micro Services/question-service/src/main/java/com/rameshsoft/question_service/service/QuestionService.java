package com.rameshsoft.question_service.service;

import com.rameshsoft.question_service.dao.QuestionDao;
...
public class QuestionService {
    ...
    public ResponseEntity<List<Integer>> getQuestionsForQUiz(String categoryName, Integer numQuestions) {
        log.info("categoryName : {}, numQuestions : {} ",categoryName,numQuestions);
